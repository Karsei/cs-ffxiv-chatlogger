...
namespace ffxiv_chatlogger
{
    internal class ChatType
    {
        ...
        public readonly static IDictionary<int, ChatType> TypeList = new Dictionary<int, ChatType>
        {
            ...
            { 0x0010, new ChatType(0x0010, ChatFormat_LS,       "#d4ff7d", "링 1") },
            { 0x0011, new ChatType(0x0011, ChatFormat_LS,       "#d4ff7d", "링 2") },
            { 0x0012, new ChatType(0x0012, ChatFormat_LS,       "#d4ff7d", "링 3") },
            { 0x0013, new ChatType(0x0013, ChatFormat_LS,       "#d4ff7d", "링 4") },
            { 0x0014, new ChatType(0x0014, ChatFormat_LS,       "#d4ff7d", "링 5") },
            { 0x0015, new ChatType(0x0015, ChatFormat_LS,       "#d4ff7d", "링 6") },
            { 0x0016, new ChatType(0x0016, ChatFormat_LS,       "#d4ff7d", "링 7") },
            { 0x0017, new ChatType(0x0017, ChatFormat_LS,       "#d4ff7d", "링 8") },
            { 0x001b, new ChatType(0x001b, ChatFormat_Novice,   "#97ef98", "초보자") },
            { 0x001d, new ChatType(0x001d, ChatFormat_Say,      "#bafff0", "감정표현") },
            { 0x0038, new ChatType(0x0038, ChatFormat_TxtOnly,  "#cccccc", "혼잣말") },
            { 0x003d, new ChatType(0x003d, ChatFormat_Say,      "#cccccc", "이벤트") },
            { 0x0044, new ChatType(0x0044, ChatFormat_Say,      "#66a574", "NPC 말하기") },
